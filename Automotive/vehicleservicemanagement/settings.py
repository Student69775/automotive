...
DATABASES = {
    'default': {
            ...
            'NAME': 'automotivedb',
            'USER': 'admin',
            'PASSWORD': 'adminautomotive2024',
            'HOST': 'automotivedb.c9jyvcm2b3ak.us-east-1.rds.amazonaws.com',
            'PORT': '3306',
            'OPTIONS': {
            'ssl': {
                'ca': 'certificate/us-east-1-bundle.pem',  # Replace with actual path
            },
        },
        },
...
AWS_ACCESS_KEY_ID = AWS_ACCESS_KEY_ID
AWS_SECRET_ACCESS_KEY = AWS_SECRET_ACCESS_KEY
AWS_STORAGE_BUCKET_NAME = 'automotives3'
